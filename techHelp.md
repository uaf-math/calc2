...
* Homework will be uploaded through Gradescope which you will access from inside Canvas.
	...
	- Most applications have export to pdf options that produce more optimized files.
...
* On an iphone, the Notes app has a "Scan Documents" option when you choose the paperclip.  It works pretty well to generate a clean PDF.
