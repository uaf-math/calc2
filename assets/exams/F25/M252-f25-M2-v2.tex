...
\item (12 pts) For each \textbf{convergent} series below, determine its sum.  
	\begin{enumerate}
	\item $\ds \sum_{n=1}^\infty \frac{(-3)^{n-1}}{2^{3n}}.$
	\vfill
	\item $\ds \sum_{n=1}^{\infty} \left( \frac{2}{n^5}-\frac{2}{(n+1)^5}\right)$
	\vfill
	\end{enumerate}
\newpage
...
\newpage
	...
	\item $\ds \sum_{n=1}^{\infty} \frac{n^7}{2^n} $

	\vfill
\newpage	
	\item $\ds \sum_{n=1}^{\infty} (-1)^{n+1} \frac{1}{\sqrt[3]{n+3}}$ 
...
\item (12 pts)
	\begin{enumerate}
	\item Find a power series representation for the function $\ds f(x)=\frac{x}{1-4x}.$
	\vfill
	...
	\end{enumerate}
\newpage
\item (8 pts) Find the Taylor series for $f(x)=\frac{1}{x}$ at $a=2.$ Your answer should be simplified.
	\vfill
	\vfill
