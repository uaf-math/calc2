...
\wkday{2}{1/22}{1/26}   & 2.3 \par \mbox{\qq{Q1} $|$ \hdue{2.1}} & \phantom{x} \par \hdue{2.2} & \phantom{x} \par \qq{Q2} & 2.4 \par \dl{drop} \\ \hline
