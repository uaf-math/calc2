...
\newcommand{\vac}[1]{\strut \footnotesize{\vacinline{#1}}}
...
\wkday{1}{1/15}{1/19}   & \vac{AK Civil Rights Day} & 2.1 & review \par \qq{Q1} & 2.2 \\ \hline

\wkday{2}{1/22}{1/26}   & 2.3 \par \hdue{2.1, 2.2} & & \phantom{x} \par \qq{Q2} & 2.4 \par \dl{drop} \\ \hline
...
\wkday{7}{2/26}{3/1}    & 3.7 & \phantom{x} \par \hdue{3.6} & 4.1 & 4.2  \\ \hline

\wkday{8}{3/4}{3/8}     & \phantom{x} \par \hdue{3.7} & 5.1 \par \hdue{4.1} & \phantom{x} \par \qq{Q6} & 5.2 \\ \hline
...
\wkday{11}{3/25}{3/29}  & \phantom{x} \par \hdue{5.3} & 5.5 \par \hdue{5.4} & \phantom{x} \par \qq{Q8} & \mbox{{\small \color{Purple} \textbf{withdrawal}}} \par \hdue{5.5} \\ \hline

\wkday{12}{4/1}{4/5}    & 5.6 & 6.1 \par \hdue{5.6} & \phantom{x} \par \qq{Q9} & 6.2 \\ \hline

\wkday{13}{4/8}{4/12}   & \phantom{x} \par \hdue{6.1} & review \par \hdue{6.2} & \ee{Midterm 2} & 6.3  \\ \hline

\wkday{14}{4/15}{4/19}  & 6.4 \par \hdue{6.3} & 7.1 \par \hdue{6.4} & \phantom{x} \par \qq{Q10} & 7.2  \\ \hline

\wkday{15}{4/22}{4/26}  & \phantom{x} \par \hdue{7.1} & 7.3 \par \hdue{7.2} & \phantom{x} \par \qq{Q11} & review  \\ \hline
