...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=blue,
    pdftitle={Syllabus for MATH F252 Spring 2026 (Bueler)},
...
\chead{\large\sf\textbf{Syllabus (Bueler)}}
...
\\
& section: &902 (CRN 31788) \\
& class time: &MWF 9:15am--10:15am \\
&&Th 9:45am--11:15am\\
& classroom: &Chap 106 \\
\\
%& Ed's office: & Chap 306C \\
& office hours: & \href{https://bueler.github.io/OffHrs.htm}{\texttt{bueler.github.io/OffHrs.htm}} \\
...
{\emph{Course webpages}} & public: \href{https://uaf-math.github.io/calc2/}{\texttt{uaf-math.github.io/calc2}}\\
 & canvas: \href{https://canvas.alaska.edu/courses/31788}{\texttt{canvas.alaska.edu/courses/31788}} \\
...
The course website contains a \href{https://uaf-math.github.io/calc2/assets/general/S26/bueler/schedule.pdf}{Schedule} listing the textbook sections to be covered each class, the dates each Homework is due, plus the dates for Quizzes and Exams. You should consult this schedule frequently.  We will announce any Schedule adjustments in class.

Most course materials (Syllabus, old Quizzes, Exams with solutions, study materials, etc.) will be posted on the \href{https://uaf-math.github.io/calc2/}{course webpage}.  A few course materials (grades, Homework solutions, announcements, link to Gradescope) will be available on the \href{https://canvas.alaska.edu/courses/31788}{Canvas site}.  Each website links to the other.

\heading{Office Hours and Communication}
Canvas will be used to make announcements for the whole class.  (\textsl{Please set up your Canvas accounts to receive these announcements in a location that is regularly checked!})  My office hours are  You are also welcome to make an appointment by email to \href{mailto:elbueler@alaska.edu}{\texttt{elbueler@alaska.edu}}.\\
...
Please write your Homework on paper, or electronically on a tablet, and turn it in as a PDF via Gradescope, accessed via the \href{https://canvas.alaska.edu/courses/30035}{Canvas page}.  

Help with scanning homework can be found on the \href{https://uaf-math.github.io/calc2/techHelp.html}{Tech Help} webpage.  Assignments are due, mostly on Mondays and Wednesdays, by 11:59pm, thus in advance of the Thursday Quiz; see the online \href{https://uaf-math.github.io/calc2/assets/general/S26/bueler/schedule.pdf}{Schedule} for due dates.  

Complete worked solutions to all Homework problems are \textbf{provided in advance on the Canvas site}.  Thus, Homework will be graded based on {effort} and {completion}. However, \textbf{the work you turn in is expected to be your own}.  
...
Attendance and participation are important parts of mastering the material, and a strong predictor of overall course performance.  At the start of two lectures per week you will do a ``2 Minute Question.''  Please answer the question, write your name on it, and turn it in.  Naturally, you'll have 2 minutes!  This will not be graded for content at all, but whether you did it will be recorded, that is, in lieu of attendance.

Please let me know by email (\href{mailto:elbueler@alaska.edu}{\texttt{elbueler\@@alaska.edu}}) if you will miss a class for any reason, and I'll excuse you from the 2-Minute Question.
...
Students will be given the opportunity to correct their Quizzes in the last third of the Thursday class.  You can earn-back up to half the missed points for doing so \textbf{accurately and thoroughly}.
...
\vskip -20pt\strut
\begin{clist}
\item \emph{Midterm 1, Thursday February 19}
\item \emph{Midterm 2, Thursday April 9}
\item  \emph{Final Exam, Wednesday April 29, 10:15am-12:15pm}
\end{clist} 

All Exams are closed book, closed notes, and no calculator.
...
\hfill  \scriptsize [syllabus version 1.0: \today] \normalsize
