...
\bigskip
MWF classes start at 9:15, Th at 9:45.  Thursday \qq{Quizzes} start after a half-hour lecture, but Thursday \ee{Midterm Exams} start at the beginning of class.  Also note UAF \dl{deadlines}.
...
\wkday{2}{9/5}{9/5}  & \vac{Labor Day} & 2.3 \par \hdue{2.1, 2.2} & 2.4 \par \qq{Q2} & \par \dl{drop} \\ \hline

\wkday{3}{9/12}{9/16}  & 2.5 \par \hdue{2.3} & 2.6 \par \hdue{2.4} & \phantom{x} \par \qq{Q3}      & 2.7   \\ \hline
...
\wkday{16}{12/12}{12/16} & \vac{no class} \par \hdue{7.4} \par Review Session & \ee{Final Exam} \par 10:15--12:15 \par Grue 409 &  &  \\ \hline
