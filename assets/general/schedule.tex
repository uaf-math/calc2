...
\wkday{12}{3/28}{4/1}  & 6.1 \par \hdue{5.6} & 6.2 \par \hdue{6.1} & \phantom{x} \par \qq{Q9} & 6.3 \phantom{x} \\ \hline

\wkday{13}{4/4}{4/8}   & 6.4 \par \hdue{6.2} & review \par \hdue{6.3} & \ee{Midterm 2} & 7.1 \\ \hline

\wkday{14}{4/11}{4/15} & \phantom{x} \par \hdue{6.4} & 7.2 \par \hdue{7.1} & \phantom{x} \par \qq{Q10} & 7.3 \\ \hline

\wkday{15}{4/18}{4/22} & \phantom{x} \par \hdue{7.2} & 7.4 \par \hdue{7.3} & \phantom{x} \par \qq{Q11} & review \par \hdue{7.4} \\ \hline
