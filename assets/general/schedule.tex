...
\wkday{10}{3/14}{3/18} & 5.3 \par \hdue{5.1} & 5.4 \par \hdue{5.2} & \phantom{x} \par \qq{Q7} & 5.5 \par \hdue{5.3} \\ \hline

\wkday{11}{3/21}{3/25} & 5.6 \par \hdue{5.4} & \phantom{x} \par \hdue{5.5} & 6.1 \par \qq{Q8} & \phantom{x} \par \dl{withdrawal} \\ \hline
