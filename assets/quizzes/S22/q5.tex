...
\problem{4}  Compute and simplify the definite integral:
  $$\int_{-1}^0 x\, e^x\,dx = \hspace{6.0in}$$
\vfill

\problem{4}  Compute and simplify the indefinite integral:
  $$\int \cos^3 \theta \sin^3 \theta\,d\theta = \hspace{6.0in}$$
\vfill

\clearpage\newpage
\problem{5}  Sketch the region between $y=\sin(3x)$ and the $x$-axis on $\pi/6 \le x \le \pi/3$.  Then compute (and simplify) the volume of the solid formed by rotating this region around the $x$-axis.
\vfill

\problem{4}  Compute and simplify the indefinite integral:
  $$\int x^2 \ln x\,dx = \hspace{6.0in}$$
\vspace{2.5in}

\clearpage\newpage
\problem{4}  Compute and simplify the indefinite integral:
  $$\int \sec t\,dt = \hspace{6.0in}$$
\vfill

\problem{4}  Compute and simplify the indefinite integral:
  $$\int \tan^3 x\,dx = \hspace{6.0in}$$
\vfill

\clearpage\newpage
\emph{Extra Credit. [2 points]}  Compute and simplify the indefinite integral:
  $$\int \sec^3 x\,dx = \hspace{6.0in}$$
\vfill
