...
\begin{enumerate}
\item (12 points) Use either the ratio test or the root test as appropriate to determine whether the series converges or diverges or state that the test is inconclusive. State the test that you are using.
	\begin{enumerate}
	\item $\ds \sum_{n=1}^{\infty} \frac{5^{n}}{n!}$ 
	\vfill
	\item $\ds \sum_{k=1}^{\infty} \left(\frac{3k}{k+1}\right)^k$
	\vfill
	\end{enumerate}

\item (4 points) For which $p$-values does the series $\ds \sum_{n=1}^{\infty} \frac{n^p}{2^n}$ converge? Justify your conclusion.
\vfill
\newpage

\item (9 points) Consider the series $\ds \sum_{n=1}^{\infty}\frac{x^n}{n}.$ % Problem 6.1.17
	\begin{enumerate}
...
\end{enumerate}
\newpage
\textbf{Extra Credit} (1 point) Suppose the series $\ds \sum_{n=0}^{\infty} a_n(x-3)^n$ converges at $x=2.$ Can you conclude that the series converges at $x=3.9$? Justify your conclusion.
\vfill
\end{document}
