...
\problem{12} Use the comparison test or the limit comparison test to determine if the series converges or diverges. A complete answer includes (i) which test you are using, (ii) a clear application of the test, and (iii) a conclusion drawn from the test. 
	...
	\begin{subproblems}
	\item $\displaystyle{\sum_{n=1}^\infty \frac{\sin^2(n)}{n^2}}$
	\vfill
	\item  $\displaystyle{\sum_{n=1}^\infty \frac{1}{2n-3}}$
	\vfill
	\newpage
	\item  $\displaystyle{\sum_{n=1}^\infty \frac{3^n}{5^n-4^n}}$
	\vfill
	\end{subproblems}
...
\problem{12} Do the series converge absolutely, conditionally, or neither (diverge)?  A complete answer includes (i) which test(s) you are using, (ii) a clear application of the test(s), and (iii) a circled answer. 
	\begin{subproblems}
	\item  $\displaystyle{\sum_{n=1}^\infty \frac{(-1)^{n+1}n}{2n+1}}$
	\vfill
	\begin{tabular}{p{4cm} p{4cm}p{4cm}}
	\textsc{converges} & \textsc{converges} & \textsc{diverges}\\
	\textsc{absolutely} & \textsc{conditionally} &\\
	\end{tabular}
	
	
\newpage		
	\item $\displaystyle{\sum_{n=1}^\infty \frac{(-1)^{n}\ln(n)}{n^2 }}$
	\vfill
	\begin{tabular}{p{4cm} p{4cm}p{4cm}}
	\textsc{converges} & \textsc{converges} & \textsc{diverges}\\
	\textsc{absolutely} & \textsc{conditionally} &\\
...
\newpage	
\item  $\displaystyle{\sum_{n=1}^\infty \frac{(-1)^n}{n^{2/3}}}$
	\vfill
	\begin{tabular}{p{4cm} p{4cm}p{4cm}}
	\textsc{converges} & \textsc{converges} & \textsc{diverges}\\
	\textsc{absolutely} & \textsc{conditionally} &\\
...
\problem{1} The sum of the convergent series  $S=\displaystyle{\sum_{n=1}^\infty \frac{(-1)^{n+1}}{n+\sqrt n}}$ is estimated by its 15th partial sum $\displaystyle{S_{15}=\sum_{n=1}^{15} \frac{(-1)^{n+1}}{n+\sqrt n}} \approx 0.3523.$ Estimate how close $S_{15}$ is to the sum of the series $S=\displaystyle{\sum_{n=1}^\infty \frac{(-1)^{n+1}}{n+\sqrt n}}$.
