...
\scriptsize \noindent 7 Sep 2022 \hfill \normalsize NAME: \underline{\hspace{60mm}}
\medskip

\thispagestyle{empty}

\noindent \textbf{Q.}\quad Sketch the region between $y=x^2$ and $y=2x$.  Find the volume from rotating this region around the $y$-axis.

% solution:
% V = \pi \int_0^4 (\sqrt(y))^2 - (y/2)^2 \,dy = \pi \int_0^4 y - \frac{y^2}{4}\,dy = \pi \left[\frac{y^2}{2} - \frac{y^3}{12}\right]_0^4 = \pi (8 - 64/12) = \pi (8 - 16/3) = 8 \pi / 3
\vfill
\end{minipage}
}
