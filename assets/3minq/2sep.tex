...
\scriptsize \noindent 2 Sep 2022 \hfill \normalsize NAME: \underline{\hspace{60mm}}
\medskip

\thispagestyle{empty}

\noindent \textbf{Q.}\quad Sketch the region between $y=x-x^2$ and the $x$-axis.  Sketch the solid of revolution from rotating that region around the $x$-axis.  Then compute the volume integral:
    $$V = \int_0^1 \pi (x - x^2)^2 \,dx = \hspace{50mm}$$
