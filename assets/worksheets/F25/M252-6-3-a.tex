...
\begin{center}
  \large
  \sc{Section 6.3: Taylor and Maclaurin Series (A first look)}\\
...
The Taylor series where $a=0,$ is called the \textbf{Maclaurin series}:

\vspace{1in}

\item Find the Taylor series for $y=\ln(x)$ at $x=1.$
