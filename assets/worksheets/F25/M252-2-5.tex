...
\begin{enumerate}
	...
	\vfill
	\item A spring has a natural length of $0.3$ m and requires 20 J of work to stretch the spring from its natural position to $0.4$ m. Find the work required to stretch the spring from $0.4$ m  to $0.5$ m.
	\vfill
	\end{enumerate}
