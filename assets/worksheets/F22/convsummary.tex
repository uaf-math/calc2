...
\begin{document}
%\scriptsize \noindent Math 252 Calculus II (Bueler) \hfill 28 March 2022
\normalsize%\medskip
...
\begin{center}
\includegraphics[width=1.0\textwidth]{../S22/figs/serieshandoutA.png}
\end{center}
\vfill
...
\begin{center}
\includegraphics[width=1.0\textwidth]{../S22/figs/serieshandoutB.png}

\vspace{-2mm}
\includegraphics[width=1.0\textwidth]{../S22/figs/serieshandoutC.png}
\end{center}
\vfill
