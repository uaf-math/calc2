...
\begin{enumerate}
\item (Review) Explain what it means for $\ds \sum_{n=1}^\infty a_n$ to be
	\begin{enumerate}
	...
	\vspace{1in}
	\end{enumerate}
\item Show that the series $\ds \sum_{n=1}^\infty \frac{\sin(2n)}{n^5}$ is convergent by showing that it is absolutely convergent.\\
\vfill
\item Show that the series $\ds \sum_{n=1}^\infty \frac{(-1)^{n}}{\sqrt{n}}$ is conditionally convergent.
\vfill
\newpage
\item The Ratio Test
...
\item Use the Ratio Test to determine if the series below converge or diverge, or explain why the test fails.
	\begin{enumerate}
	\item $\ds \sum_{n=1}^\infty \frac{(-2)^n}{n!}$
	\vfill
	\item $\ds \sum_{n=1}^\infty \frac{n^n}{n!}$
	\vfill
	\item $\ds \sum_{n=1}^\infty \frac{2}{3n+10}$
	\vfill
	\end{enumerate}
\end{enumerate}
