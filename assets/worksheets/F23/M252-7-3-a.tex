...
\begin{center}
  \large
  \sc{Section 7.3: Polar Coordinates (day 1)}\\
   
\end{center}

\begin{enumerate}
\item The definition of polar coordinates

\vfill
\item In the polar grids below, graph the points $P=(2.5, 5 \pi /4),$ $Q=(-3, \pi/2),$ $r=1$, and $\theta = \pi/6.$\\
