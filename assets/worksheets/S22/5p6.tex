...
\begin{center}
\includegraphics[width=1.0\textwidth]{figs/serieshandoutA.png}
\end{center}
\vfill
...
\begin{center}
\includegraphics[width=1.0\textwidth]{figs/serieshandoutB.png}

\vspace{-2mm}
\includegraphics[width=1.0\textwidth]{figs/serieshandoutC.png}
\end{center}
\vfill
